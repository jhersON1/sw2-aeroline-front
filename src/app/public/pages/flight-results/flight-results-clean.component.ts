        ...
        @if (loading) {
                    ...
                    <div class="lg:col-span-2">
                      <div class="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p class="text-sm text-gray-600">{{ flight.aircraft.model || 'Aircraft' }}</p>
                        </div>
                      </div>
                      
                      <div class="mt-4 flex items-center space-x-6">
                        <div class="text-center">
                          <p class="text-2xl font-bold">{{ formatTime(flight.departureTime) }}</p>
                        ...
                        <div class="flex-1 text-center">
                          ...
                          <p class="text-sm text-gray-600 mt-2">{{ formatDuration(flight.duration) }}</p>
                        </div>
                        
                        <div class="text-center">
                          <p class="text-2xl font-bold">{{ formatTime(flight.arrivalTime) }}</p>
          ...
          <div class="mt-8 text-center text-gray-600">
            ...
            <div class="mt-4 p-4 bg-gray-100 rounded text-xs text-left">
              ...
              Loading: {{ loading }}<br>
              Flights Length: {{ flights.length }}<br>
              Origin: {{ origin }} ({{ originCity }})<br>
              Destination: {{ destination }} ({{ destinationCity }})<br>
              Date: {{ departureDate }}<br>
